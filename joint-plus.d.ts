...
This Source Code Form is subject to the terms of the JointJS+ Trial
License, v. 2.0. If a copy of the JointJS+ Trial License was not
...
declare class Clipboard extends mvc.Collection<mvc.Model> {
	...
	*/
	...
	protected updateFromStorage(graph: dia.Graph): void;
...
declare class ForceDirected extends mvc.Model {
	...
	protected radialForceFunction: ForceDirected.RadialForceFunction | null;
	protected useRadialForce: boolean;
	protected useRepulsiveForce: boolean;
	initialize(): void;
	protected createDefaultRadialForceFunction(strength: number): (params: ForceDirected.RadialForceFunctionParams) => number;
	start(): void;
...
declare class Navigator extends mvc.View<undefined> {
	...
	sourcePaper: dia.Paper;
	targetPaper: dia.Paper;
	render(): this;
...
declare class PaperScroller extends mvc.View<undefined> {
	...
	virtualRenderingController: PaperScroller.VirtualRenderingController | null;
	lock(): this;
	unlock(): this;
	render(): this;
	...
	isElementVisible(element: dia.Element, opt?: PaperScroller.IsElementVisibleOptions): boolean;
	...
	protected requestPaperSizeUpdate(): void;
	protected onBackgroundEvent(evt: dia.Event): void;
	protected onScroll(evt: dia.Event): void;
	protected onResize(): void;
	protected onPaperResize(): void;
	protected onPaperScale(sx: number, sy: number): void;
	protected onGraphChange(): void;
...
declare class QuadNode<T extends QuadNode.Rect> extends Array {
	...
	queryRect(rect: QuadNode.Rect, strict: boolean, filter?: QuadTree.ObjectFilter<T>): T[];
	queryPoint(point: QuadNode.Point, strict: boolean, filter?: QuadTree.ObjectFilter<T>): T[];
	hasRect(rect: QuadNode.Rect, strict: boolean, filter?: QuadTree.ObjectFilter<T>): boolean;
	hasPoint(point: QuadNode.Point, strict: boolean, filter?: QuadTree.ObjectFilter<T>): boolean;
	clear(): void;
...
declare class SearchGraph extends dia.Graph {
	...
	protected qtIndexFilter: SearchGraph.IndexFilter | null;
	...
	protected queryQuadTreeRect(rect: dia.BBox, strict?: boolean, filter?: SearchGraph.ObjectFilter): SearchGraph.Object[];
	protected queryQuadTreePoint(point: dia.Point, strict?: boolean, filter?: SearchGraph.ObjectFilter): SearchGraph.Object[];
	...
	setQuadTreeIndexFilter(filter: SearchGraph.IndexFilter | null): void;
	findElementsInArea(area: dia.BBox, options?: SearchGraph.FindInAreaOptions): dia.Element[];
	findLinksInArea(area: dia.BBox, options?: SearchGraph.FindInAreaOptions): dia.Link[];
	findCellsInArea(area: dia.BBox, options?: SearchGraph.FindInAreaOptions): dia.Cell[];
	findElementsAtPoint(point: dia.Point, options?: SearchGraph.FindAtPointOptions): dia.Element[];
	findLinksAtPoint(point: dia.Point, options?: SearchGraph.FindAtPointOptions): dia.Link[];
	findCellsAtPoint(point: dia.Point, options?: SearchGraph.FindAtPointOptions): dia.Cell[];
	findElementsUnderElement(element: dia.Element, options?: SearchGraph.FindUnderElementOptions): dia.Element[];
	findLinksUnderElement(element: dia.Element, options?: SearchGraph.FindUnderElementOptions): dia.Link[];
	findCellsUnderElement(element: dia.Element, options?: SearchGraph.FindUnderElementOptions): dia.Cell[];
	...
	hasElementsInArea(area: dia.BBox, options?: SearchGraph.FindInAreaOptions): boolean;
	hasLinksInArea(area: dia.BBox, options?: SearchGraph.FindInAreaOptions): boolean;
	hasCellsInArea(area: dia.BBox, options?: SearchGraph.FindInAreaOptions): boolean;
	protected hasInArea(area: dia.BBox, strict?: boolean, filter?: SearchGraph.ObjectFilter): boolean;
	protected hasInAreaNoIndex(cells: dia.Cell[], area: dia.BBox, options?: dia.Graph.FindInAreaOptions): boolean;
	hasElementsAtPoint(point: dia.Point, options?: SearchGraph.FindAtPointOptions): boolean;
	hasLinksAtPoint(point: dia.Point, options?: SearchGraph.FindAtPointOptions): boolean;
	hasCellsAtPoint(point: dia.Point, options?: SearchGraph.FindAtPointOptions): boolean;
	protected hasAtPoint(point: dia.Point, strict?: boolean, filter?: SearchGraph.ObjectFilter): boolean;
	protected hasAtPointNoIndex(cells: dia.Cell[], point: dia.Point, options?: dia.Graph.FindAtPointOptions): boolean;
	static isObjectLink(obj: SearchGraph.Object): boolean;
	static isObjectElement(obj: SearchGraph.Object): boolean;
}
...
declare class Selection<C extends mvc.Collection = mvc.Collection<any>> extends mvc.View<undefined> {
...
declare class Stencil extends mvc.View<undefined> {
	...
	protected getDropArea(el: mvc.$Element): g.Rect;
...
declare class TreeLayout extends mvc.Model {
	...
	positionTree(root: dia.Element, x: number, y: number, opt?: TreeLayout.UpdateOptions): void;
	getLayoutArea(element: dia.Element | dia.Cell.ID): TreeLayout.LayoutArea | null;
...
declare class Validator extends mvc.Model {
	...
	addRule(actions: string, ...callback: Array<Validator.Callback>): void;
	removeRule(actions: string, ...callback: Array<Validator.Callback>): void;
	removeRule(actions: string): void;
	clearRules(): void;
	protected parseActions(actions: string): string[];
	protected throwError(message: string): void;
	protected _onCommand(command: CommandManager.Command): void;
	protected _validateCommand(command: CommandManager.Command): boolean;
	/**
	 * @deprecated use `addRule` method instead
...
declare namespace ForceDirected {
	...
	type RadialForceFunction = (params: RadialForceFunctionParams) => number;
	interface RadialForceFunctionParams {
		radiusSum: number;
		distance: number;
		u: ElementData;
		v: ElementData;
	...
	interface Options {
		...
		width?: number;
		height?: number;
		radialForceStrength?: number | RadialForceFunction;
...
declare namespace Inspector {
	...
	interface Options extends mvc.ViewOptions<undefined> {
		...
		renderLabel?: (opt: {
			[key: string]: any;
		}, path: string, inspector: Inspector) => mvc.$HTMLElement | undefined;
		renderFieldContent?: (opt: {
			[key: string]: any;
		}, path: string, value: any, inspector: Inspector) => mvc.$HTMLElement | undefined;
		focusField?: (opt: {
			[key: string]: any;
...
declare namespace PaperScroller {
	...
	interface AutoResizePaperOptions {
		useGraphEvents?: boolean;
	}
	interface Options extends mvc.ViewOptions<undefined> {
		paper: dia.Paper;
		padding?: dia.Padding | ((paperScroller: PaperScroller) => dia.Padding);
		minVisiblePaperSize?: number;
		autoResizePaper?: boolean | AutoResizePaperOptions;
		baseWidth?: number;
		baseHeight?: number;
		...
		borderless?: boolean;
		virtualRendering?: boolean | VirtualRenderingController.Options;
	}
	...
	namespace VirtualRenderingController {
		interface Options {
			margin?: number;
			prioritizedCellVisibility?: boolean | ((paperScroller: PaperScroller) => boolean);
			cellVisibility?: boolean | dia.Paper.CellVisibilityCallback;
		}
	}
	class VirtualRenderingController extends mvc.View<undefined> {
		paperScroller: PaperScroller;
		paper: dia.Paper;
		protected frameId: number | null;
		protected viewportBBox: g.Rect | null;
		readonly isRunning: boolean;
		constructor(paperScroller: PaperScroller, options?: VirtualRenderingController.Options);
		start(): void;
		stop(): void;
		requestUpdate(): void;
		cancelUpdate(): void;
		protected startListening(): void;
		protected setPaperCellVisibility(): void;
		protected getPaperCellVisibilityCallback(): dia.Paper.CellVisibilityCallback;
		protected isCellInCachedViewport(cell: dia.Cell): boolean;
		protected cacheCurrentViewportBBox(): void;
		protected updateViewportCellsVisibility(): void;
		protected prioritizeViewportCellsVisibility(): boolean;
		protected throwError(message: string): void;
	}
}
...
declare namespace QuadTree {
	...
	type ObjectFilter<T extends Object> = (obj: T) => boolean;
}
...
declare namespace SearchGraph {
	export interface Object extends QuadTree.Object {
		id: dia.Cell.ID;
		link: boolean;
	}
	export type ObjectFilter = QuadTree.ObjectFilter<Object>;
	export type IndexFilter = (cell: dia.Cell) => boolean;
	interface UseIndexOptions {
		useIndex?: boolean;
	}
	export interface FindInAreaOptions extends dia.Graph.FindInAreaOptions, UseIndexOptions {
	}
	export interface FindAtPointOptions extends dia.Graph.FindAtPointOptions, UseIndexOptions {
	}
	export interface FindUnderElementOptions extends dia.Graph.FindUnderElementOptions, UseIndexOptions {
	}
...
declare namespace TreeLayoutView {
	...
	type FallbackToAncestorCallback = ((elements: dia.Element[], candidate: dia.Element, siblingRank: number, direction: TreeLayout.Direction, treeLayoutView: TreeLayoutView) => dia.Element | null);
	type SnapToClosestElementOptions = {
		radius?: number;
	};
	export interface Options extends mvc.ViewOptions<TreeLayout> {
		...
		paperConstructor?: typeof dia.Paper;
		paperOptions?: dia.Paper.Options;
		fallbackToAncestor?: FallbackToAncestorCallback | boolean;
		snapToClosestElement?: SnapToClosestElementOptions | boolean;
		[key: string]: any;
	}
}
declare namespace Validator {
	...
	type Callback = (err: any, command: CommandManager.Command, next: NextRule) => void;
}
